...
namespace IIS.Postamat
{
    ...
    [View("ТранзакцияE", new string[] {
            ...
            "Получатель.ФИО"})]
    [MasterViewDefineAttribute("ТранзакцияE", "Получатель", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "ФИО")]
    ...
    public class Транзакция : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Postamat.Получатель fПолучатель;
        ...
        /// Транзакция.
        /// </summary>
        // *** Start programmer edit section *** (Транзакция.Получатель CustomAttributes)

        // *** End programmer edit section *** (Транзакция.Получатель CustomAttributes)
        [PropertyStorage(new string[] {
                "Получатель"})]
        [NotNull()]
        public virtual IIS.Postamat.Получатель Получатель
        {
            get
            {
                // *** Start programmer edit section *** (Транзакция.Получатель Get start)

                // *** End programmer edit section *** (Транзакция.Получатель Get start)
                IIS.Postamat.Получатель result = this.fПолучатель;
                // *** Start programmer edit section *** (Транзакция.Получатель Get end)

                // *** End programmer edit section *** (Транзакция.Получатель Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Транзакция.Получатель Set start)

                // *** End programmer edit section *** (Транзакция.Получатель Set start)
                this.fПолучатель = value;
                // *** Start programmer edit section *** (Транзакция.Получатель Set end)

                // *** End programmer edit section *** (Транзакция.Получатель Set end)
            }
        }
